:SE:
:INTRO:
Nu när tentorna (förhoppningsvis) är över och tentastressen förlorat sitt övertag
är det givetvis dags för fler event med LiTHe kod! Våren tar med sig både
game jam och förändringar som vi vill att alla ska vara del av!

:POINT: LiTHe kod-styrelsen 21/22
Som för många andra föreningar har COVID gjort det svårt att värva nya styrelsemedlemmar.
Vi har ett <a href="https://forms.gle/kSiz6EsvP6dteDQ99">formulär uppe för intresseanmälan</a>.
Intresseanmälan är inte bindande, och tar ungefär 30 sekunder att fylla i.

Typiskt bra att sätta på CV:t och ett tillfälle att få vara del av något större!
...
av 1000 små fjärilar. Många har försökt hitta lösningar och nästan lika många
har misslyckats. I LiTHe kod vet man dock vad detta betyder: Swedish Coding Cup
nalkas!
...
att hållas i <a href="https://discord.gg/KAuYzbmYrh">LiU Game Jams discordserver</a>!

Ett game jam innebär att man gör ett spel på en helg. Under tidigare jams har
spel gjorts i välkända spelmotorer så som Unity, Unreal, Godot, Excel, Git och
verkligheten. Om man är intresserad är det ett jättebra tillfälle att bli
introducerad till verktyg, tekniker och idéer.  Man behöver absolut inte ha
vunnit programmerings-SM för att vara med, alla har något att bidra med!
...
:EN:
:INTRO:
Now when the exams (hopefully) are over and the exam angst has lost its grip,
it is of course time for more events with LiTHe kod! This spring brings both
game jams and changes that we want everyone to be a part of!

:POINT: The LiTHe kod board 21/22
Like many other organizations, LiTHe kod has had trouble finding a board for 21/22.
If you are intrested, take 30 seconds to fill out <a href="https://forms.gle/kSiz6EsvP6dteDQ99">our interest form</a>.

It's great to have on your CV and a perfect opportunity to learn and grow as a person.

:POINT: Minecraft Triathlon
The term can't end without fireworks! Unfortunately we can't shoot them in person,
but Minecraft doesn't have COVID restrictions (yet).

LiTHe kod would love to invite you to a collection of Minecraft competitions with
a chance to win prices and hang out!

The competitions will be held the 27th of April at 5 PM
...
be held in <a href="https://discord.gg/KAuYzbmYrh">LiU Game Jam's Discord server</a>!
